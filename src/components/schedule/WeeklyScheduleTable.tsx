  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          <h2 className="text-base sm:text-lg font-semibold text-gray-900">Your Weekly Schedule</h2>
          <p className="text-xs sm:text-sm text-gray-600">Study assignments for this week</p>
        </div>
      </div>
