...
import { Sun, Moon, Clock, Maximize, Minimize } from 'lucide-react';
...
export function QuizHeader({
          ...
          <div className="flex items-center justify-between p-4 sm:p-6">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <button
                ...
                className={`p-2 sm:p-3 rounded-lg ${themeClasses.timerButton} transition-all duration-200`}
  ...
  // Regular header for non-fullscreen mode
  return (
